...
#pragma region Level01
	if (m_level == 1)
	{
		...
		world += "00000000000000000T000000000000000000000000000000NWDDDDSSSSSSSSSSSSSSSSSSSSDDGG000000000000000000000000000000GGGGGGGG000000GSSSSSDWWWWWWWWWWDSSSSSSSSSSSSSS\n";
	...
	for (int i = 0; i < world.length(); i++)
	{
		...
		if (world[i] == 'T')
		{
			...
			CTexturedObject* pWorld01 = new CTexturedObject("Texture/World/test.png",
				SVector2(154, 30), SVector2(1540, 300));
