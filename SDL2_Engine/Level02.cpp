...
#pragma region BossLevel
	...
	world += "0000000000000000000000300000SSSSS00000SSSSSS0000S0000S0000SS000S00000000SS0000000000000000000000000000SSSSSSS000000000000000000000000000000000000000000000\n";
...
#pragma endregion Level02
	...
	for (int i = 0; i < world.length(); i++)
	{
		...
		{
			// load NPC and add to ctm
			GNPC* pNpc3 = new GNPC("Texture/NPC/T_Npc.png",
				SVector2(width * BLOCK_WIDTH, (height - 1.5f) * BLOCK_HEIGHT), SVector2(55, 64));
			pNpc3->SetTag("NPC3");
			pNpc3->SetColType(COL);
			pNpc3->Init();
			CTM->AddPersistantObject(pNpc3);
		}
		// if NPC 1
		else if (world[i] == '2')
		{
