...
#pragma region constructor
	...
	GBullet(SVector2 _pos = SVector2(), SVector2 _size = SVector2()) : CMoveObject(_pos, _size) {}
	...
	GBullet(const char* _pFileName, SVector2 _pos, SVector2 _size) : CMoveObject(_pFileName, _pos, _size) {}
#pragma endregion
